...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="pull-left">
            ...
            <a class="btn btn-secondary" href="<?php echo e(route('mahasiswa.create')); ?>">Input Data</a>
        <br><br>
    </div>
</div>
...
<?php echo $__env->make('mahasiswa.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WINDA\project\resources\views/mahasiswa/index.blade.php ENDPATH**/ ?>